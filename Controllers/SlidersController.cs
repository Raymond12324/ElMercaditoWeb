...
namespace ElMercaditoWeb.Controllers
{
    public class SlidersController : Controller
    {
        ...
        public SlidersController(SupermercadoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Img1,Img2,Img3")] Slider slider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Img1,Img2,Img3")] Slider slider)
        {
            if (id != slider.Id)
            {
                return NotFound();
